package com.lnb.school.student.dtos.oas;
...
public class StudentOAS {
    ...
    public class Request {
        ...
        public String sidn;
        @Schema(required = true, example = "Harry Potter")
        public String name;
        @Schema(required = true, example = "harry.potter@gmail.com")
        public String email;
        @Schema(required = true, example = "+1555555555")
        public String phone;
    }
