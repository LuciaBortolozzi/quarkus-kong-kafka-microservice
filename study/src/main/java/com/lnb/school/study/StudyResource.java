...
import com.lnb.school.study.dtos.oas.StudyOAS;
import com.lnb.school.study.services.StudyService;
...
public class StudyResource {
    ...
    public Response addProfessor(StudyRequestDto request) throws ValidationException, JsonProcessingException {
    ...
    public Response updateProfessor(StudyRequestDto request, @PathParam("id") ObjectId id) throws ValidationException {
    ...
    public Response getProfessorByID(@PathParam("id") ObjectId id) {
    ...
    public Response deleteProfessor(@PathParam("id") ObjectId id) throws ValidationException {
